...
public class DBHandler extends SQLiteOpenHelper {
    ...
    //DATABASE NAME
    public static final String DATABASE_NAME = "parkshark.com";
    ...
    public void addUser(User user) {
        ...
        values.put(KEY_LICENSEPLATE, user.licensePlate);
    ...
    public User Authenticate(User user) {
        ...
        Cursor cursor = db.query(TABLE_USERS,// Selecting Table
                new String[]{KEY_ID, KEY_NAME, KEY_EMAIL, KEY_PASSWORD, KEY_ADDRESS, KEY_LICENSEPLATE},//Selecting columns want to query
                KEY_EMAIL + "=?",
